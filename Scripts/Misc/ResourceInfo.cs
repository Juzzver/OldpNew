		...
		private static CraftResourceInfo[] m_MetalInfo = new CraftResourceInfo[]
			{
				...
				new CraftResourceInfo( 0x973, 0, "Silver",   CraftAttributeInfo.Silver,  CraftResource.Silver,       typeof( SilverIngot ),  typeof(SilverOre ),    typeof( SilverGranite ) ),
				new CraftResourceInfo( 0x966, 0, "Stone",   CraftAttributeInfo.Stone,  CraftResource.Stone,       typeof( StoneIngot ),  typeof( StoneOre ),    typeof( StoneGranite ) ),
				new CraftResourceInfo( 0x96D, 0, "Gypsum",        CraftAttributeInfo.Gypsum,      CraftResource.Gypsum,           typeof( GypsumIngot ),      typeof( GypsumOre ),        typeof( GypsumGranite ) ),
				...
				new CraftResourceInfo( 0x979, 0, "Titan",       CraftAttributeInfo.Titan,     CraftResource.Titan,          typeof( TitanIngot ),     typeof( TitanOre ),       typeof( TitanGranite ) ),
				new CraftResourceInfo( 0x8AB, 1053101, "Valorite",      CraftAttributeInfo.Valorite,    CraftResource.Valorite,         typeof( ValoriteIngot ),    typeof( ValoriteOre ),      typeof( ValoriteGranite ) ),
				new CraftResourceInfo( 0x89F, 1053102, "Verite",        CraftAttributeInfo.Verite,      CraftResource.Verite,           typeof( VeriteIngot ),      typeof( VeriteOre ),        typeof( VeriteGranite ) ),

			 
				new CraftResourceInfo( 0x973, 0, "Blue Rock",   CraftAttributeInfo.BlueRock,  CraftResource.BlueRock,       typeof( BlueRockIngot ),  typeof( BlueRockOre ),    typeof( BlueRockGranite ) ),
				new CraftResourceInfo( 0x966, 0, "Aqua",   CraftAttributeInfo.Aqua,  CraftResource.Aqua,       typeof( AquaIngot ),  typeof( AquaOre ),    typeof( AquaGranite ) ),
				
				new CraftResourceInfo( 0x972, 0, "Plazma",        CraftAttributeInfo.Plazma,      CraftResource.Plazma,           typeof( PlazmaIngot ),      typeof( PlazmaOre ),        typeof( PlazmaGranite ) ),
				new CraftResourceInfo( 0x8A5, 0, "Crystal",          CraftAttributeInfo.Crystal,      CraftResource.Crystal,             typeof( CrystalIngot ),        typeof( CrystalOre ),          typeof( CrystalGranite ) ),
				new CraftResourceInfo( 0x89F, 0, "Acid",        CraftAttributeInfo.Acid,      CraftResource.Acid,           typeof( AcidIngot ),      typeof( AcidOre ),        typeof( AcidGranite ) ),
				new CraftResourceInfo( 0x979, 0, "Plutonium",       CraftAttributeInfo.Plutonium,     CraftResource.Plutonium,          typeof( PlutoniumIngot ),     typeof( PlutoniumOre ),       typeof( PlutoniumGranite ) ),
				new CraftResourceInfo( 0x8AB, 0, "Blood Rock",      CraftAttributeInfo.BloodRock,    CraftResource.BloodRock,         typeof( BloodRockIngot ),    typeof( BloodRockOre ),      typeof( BloodRockGranite ) ),

				new CraftResourceInfo( 0x973, 0, "Glory",		    CraftAttributeInfo.Glory,  CraftResource.Glory,       typeof( GloryIngot ),  typeof( GloryOre ),    typeof( GloryGranite ) ),
				new CraftResourceInfo( 0x966, 0, "Frost",   CraftAttributeInfo.Frost,  CraftResource.Frost,       typeof( FrostIngot ),  typeof( FrostOre ),    typeof( FrostGranite ) ),
				new CraftResourceInfo( 0x96D, 0, "Meteor",        CraftAttributeInfo.Meteor,      CraftResource.Meteor,           typeof( MeteorIngot ),      typeof( MeteorOre ),        typeof( MeteorGranite ) ),
				new CraftResourceInfo( 0x972, 0, "Blue Steel",        CraftAttributeInfo.BlueSteel,      CraftResource.BlueSteel,           typeof( BlueSteelIngot ),      typeof( BlueSteelOre ),        typeof( BlueSteelGranite ) ),
				new CraftResourceInfo( 0x8A5, 0, "Iridium",          CraftAttributeInfo.Iridium,      CraftResource.Iridium,             typeof( IridiumIngot ),        typeof( IridiumOre ),          typeof( IridiumGranite ) ),
				new CraftResourceInfo( 0x979, 0, "White Stone",       CraftAttributeInfo.WhiteStone,     CraftResource.WhiteStone,          typeof( WhiteStoneIngot ),     typeof( WhiteStoneOre ),       typeof( WhiteStoneGranite ) ),
				new CraftResourceInfo( 0x89F, 0, "Diamond",        CraftAttributeInfo.Diamond,      CraftResource.Diamond,           typeof( DiamondIngot ),      typeof( DiamondOre ),        typeof( DiamondGranite ) ),
				...
				new CraftResourceInfo( 0x96D, 0, "Shadow",        CraftAttributeInfo.Shadow,      CraftResource.Shadow,           typeof( ShadowIngot ),      typeof( ShadowOre ),        typeof( ShadowGranite ) ),
				new CraftResourceInfo( 0x972, 0, "Legendary",        CraftAttributeInfo.Legendary,      CraftResource.Legendary,           typeof( LegendaryIngot ),      typeof( LegendaryOre ),        typeof( LegendaryGranite ) ),
				new CraftResourceInfo( 0x8A5, 0, "Lava",          CraftAttributeInfo.Lava,      CraftResource.Lava,             typeof( LavaIngot ),        typeof( LavaOre ),          typeof( LavaGranite ) ),
