...
namespace Xanthos.ShrinkSystem
{
	public class ShrinkItem : Item, IShrinkItem
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
            ...
            else if ( from.Region.IsPartOf( typeof( Server.Engines.ConPVP.SafeZone ) ) )
                from.Send( new AsciiMessage( this.Serial, this.ItemID, MessageType.Regular, 0x22, 3, "", "You cannot unshrink your pet to this location." ) );
