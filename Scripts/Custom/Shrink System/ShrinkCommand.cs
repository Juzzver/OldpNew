...
namespace Xanthos.ShrinkSystem
{
    public class ShrinkCommands
    {
        ...
        {
            CommandHandlers.Register( "Shrink", AccessLevel.Administrator, new CommandEventHandler( Shrink_OnCommand ) );
    ...
    public class ShrinkTarget : Target
    {
        ...
        protected override void OnTarget( Mobile from, object target )
        {
         ...
         /*   else if ( target is GuildSteed )
                from.SendMessage( "You cannot shrink a Guild Steed" );*/
