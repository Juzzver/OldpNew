		...
		private static Type[][] m_TypesTable = new Type[][]
			{
				...
				new Type[]{ typeof( AspenLog        ), typeof(AspenBoard) },
				new Type[]{ typeof( ElvenLog        ), typeof(  ElvenBoard        ) },
				new Type[]{ typeof( DendroidLog     ), typeof(  DendroidBoard     ) },
				new Type[]{ typeof( ScorpionLog     ), typeof(  ScorpionBoard     ) },
				new Type[]{ typeof( FrozenLog       ), typeof(  FrozenBoard       ) },
				new Type[]{ typeof( HamelionLog     ), typeof(  HamelionBoard     ) },
				new Type[]{ typeof( IceLog          ), typeof(  IceBoard          ) },
				new Type[]{ typeof( RoseLog         ), typeof(  RoseBoard         ) },
				new Type[]{ typeof( DeadLog         ), typeof(  DeadBoard         ) },
				new Type[]{ typeof( HolyLog         ), typeof(  HolyBoard         ) },
				new Type[]{ typeof( ArianLog        ), typeof(  ArianBoard        ) },
				new Type[]{ typeof( MillenniumLog   ), typeof(  MillenniumBoard   ) },
				new Type[]{ typeof( MysticLog       ), typeof(  MysticBoard       ) },
				new Type[]{ typeof( TeriumLog       ), typeof(  TeriumBoard       ) },
				new Type[]{ typeof( AncientLog      ), typeof(  AncientBoard      ) },
				new Type[]{ typeof( LifeLog         ), typeof(  LifeBoard         ) },
				new Type[]{ typeof( ChaosLog        ), typeof(  ChaosBoard        ) },
				new Type[]{ typeof( LegendaryBlackOakLog ), typeof( LegendaryBlackOakBoard) },
